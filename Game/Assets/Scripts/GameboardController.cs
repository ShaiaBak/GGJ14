...
public class GameboardController : MonoBehaviour {
	...
	public void CreateWall(int x, int y, int direction) {
		TileClass tile = GetTileAtCoordinate (x, y).GetComponent<TileClass>(); // shouldn't be null
	...
	public void DestroyWall(int x, int y, int direction) {
		TileClass tile = GetTileAtCoordinate (x, y).GetComponent<TileClass>(); // hope it's not null
